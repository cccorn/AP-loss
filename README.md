...
We release this PyTorch implementation instead of MXNet due to an engineering [issue](https://github.com/apache/incubator-mxnet/issues/8884). The python custom operator in MXNet does not run in parrallel when using multi-gpus. It is more practical to implement AP-loss in PyTorch, for faster training speed. 
